...
import baseline.src.numpy_utility as pnu
from baseline.src.file_utility import save_stuff, flatten_dict, embed_dict

import torch
import torch.nn as nn

from baseline.torchmodel.models.alexnet import Alexnet_fmaps
...
def load_encoding(subject, model_name='dnn_fwrf',device=torch.device("cpu")):
    ...
    root_dir = "./"
    output_dir = root_dir + "baseline/output/S%02d/%s/" % (subject,model_name) 
