...
# Training Process
# Roadmap/Todos
- Implement a command line interface to specify the network architecture (e.g. Alex-Net-like CNN, fully connected ANN, etc.) and optimization techniques (e.g. Adam, SGD, and hyperparameters). Status: *MOSTLY COMPLETED*.
- Implement a logging system for effective debugging. Status: *MOSTLY COMPLETED*.
